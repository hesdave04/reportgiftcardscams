...
export default function Page() {
  ...
  "@graph": [
    {
      "@type": "WebPage",
      "@id": "https://scamcomplaints.org/report-elder-fraud/#webpage",
      "url": "https://scamcomplaints.org/report-elder-fraud",
      "name": "Report a Elder Fraud | ScamComplaints",
      "isPartOf": {
        "@id": "https://scamcomplaints.org/#website"
      },
      "breadcrumb": {
        "@id": "https://scamcomplaints.org/report-elder-fraud/#breadcrumb"
      }
    },
    {
      "@type": "BreadcrumbList",
      ...
      "itemListElement": [
        ...
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": "Report Elder Fraud",
          "item": "https://scamcomplaints.org/report-elder-fraud"
        }
      ]
    }
  ]
      ...
      <section className="border-t border-slate-100 bg-white">
        <div className="mx-auto max-w-4xl px-4 py-10">
          ...
          <div className="mt-5 grid gap-3 sm:grid-cols-2">
              <a href="/report-grandparent-scam" className="group flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-4 transition hover:border-slate-300 hover:shadow-sm">
                <span className="text-sm font-medium text-slate-900 group-hover:text-red-600">Report Grandparent Scam</span>
