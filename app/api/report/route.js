export const dynamic = 'force-dynamic'; // avoid static rendering attempts
...
export async function POST(request) {
  try {
    ...
    if (!supabaseAdmin) {
      return NextResponse.json({ error: 'Server not configured: missing SUPABASE_URL or SERVICE_ROLE_KEY' }, { status: 500 });
    }
